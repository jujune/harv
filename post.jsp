...
<head>
<meta charset="utf-8"> <!-- meta는 html 파일의 인코딩을 알려주는 태그 -->
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<!--width=device-width 웹 페이지의 크기가 모니터가 스마트폰의 실제 액정 크기를 따라가게 함 --> <!-- initial-scale=1 화면 zoom-up정도 1배율로 함 -->
<!-- viewport는 웹 페이지 크기를 결정 --> <!-- shirink-to-fit=no 사파리 브라우저에서 내용을 줄여서 보여주는 것을 방지 -->
<meta http-equiv="X-UA-Compatible" content="ie=edge">
<!-- X-UA-Compatible 태그로 웹의 호환성을 지정할 수 있도록 하였음 / IE=edge는 IE브라우저에서, 각 버전 중 가장 최신 버젼의 엔진을 선택하라는 뜻(IE6부터 IE11까지) -->
...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarsDefault">
    	...
    	<ul class="navbar-nav ml-auto align-items-center">
    		...
    		<li class="nav-item">
    		<a class="nav-link" href="author.jsp"><img class="rounded-circle mr-2" src="assets/img/av.png" width="30"><span class="align-middle">Author</span></a>
    		</li>
